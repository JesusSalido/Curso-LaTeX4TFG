...
% -------------------------
\autor{Autor/a}
\email{autor-a@uclm.es}					
\instEdu{UNIVERSIDAD DE CASTILLA-LA MANCHA}
\centroEdu{FACULTAD DE LETRAS}
\titulacion{MÁSTER UNIVERSITARIO EN INVESTIGACIÓN EN LETRAS Y HUMANIDADES} 
\tipoDoc{TRABAJO FIN DE MÁSTER}
...
\input{./preambulo/Portada} % Diseño de portadas
\input{./preambulo/Resumen} % Resumen/Abstract
\input{./preambulo/Agradecimientos} % Agradecimientos etc.
\input{./preambulo/Indices} % Índice de contenido, figuras, tablas
%--- (FIN FRONTMATTER)
...
%---
% Comentar si se emplea lista de \bibitem{citekey} 
\bibliography{biblio} % Nombre del fichero .bib (sin extensión)
% -------------------------
