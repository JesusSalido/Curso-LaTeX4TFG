...
\hypersetup{
	breaklinks,
	% OJO: Debe comentarse por incompatibilidad con paquete "menukeys" 
...
% Estas definiciones permiten cambiar el estilo de los elementos. Si se desean otros estilos o su configuación es preciso recurrir a la documentación del paquete (no merece la pena).
