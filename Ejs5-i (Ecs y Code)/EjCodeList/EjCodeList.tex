...
\usepackage[% Las opciones del paquete indican el tipo de licencia.
	type={CC}, % Creative Commons
	modifier={by-sa}, % by (con atribución) sa (compartir igual)
	version={4.0}, % versión
]{doclicense}
...
\lstinputlisting[language=C,caption={Ejemplo de código C desde un fichero externo},label=lst:codCfile]{../code/HolaMundo.c}
...
\lstinputlisting[language=Python,caption={Ejemplo de código Python desde un fichero externo},label=lst:pyfile]{../code/pyexample.py}
