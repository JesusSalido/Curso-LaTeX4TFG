...
\begin{figure}[hbt]
	\centering 
	\includegraphics[width=0.9\textwidth]{4004arch} 
...
\begin{figure}[hbt]
	\centering
	\includegraphics[width=0.9\textwidth]{Mars_Perseverance} 
...
jpg & Imágenes (> 100 ppi) \\
png & Capturas de pantalla (> 75 ppi) 
\end{tabular}
\end{table}
...
Cuando se presenta la necesidad de incluir un gráfico demasiado grande para el tamaño de la página una opción muy apropiada es la impresión del gráfico en modo apaisado en una página aparte. Este efecto se consigue con el entorno \texttt{sidewaysfigure} proporcionado por el paquete \texttt{rotating}. La Fig.~\ref{fig:sideways} muestra un ejemplo del entorno citado con un gráfico \textsf{PDF}.
