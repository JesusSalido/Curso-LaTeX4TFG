...
\begin{sidewaysfigure}
	\centering
	\includegraphics[width=0.98\textheight]{../figs/network.png} 
	\caption[Gráfico girado de Visio (png)]{Figura raster con impresión girada}
	\label{fig:girada}
\end{sidewaysfigure}
...
\begin{landscape}
También es posible imprimir una página en formato apaisado cuando contiene una figura muy ancha. Este efecto se consigue con el paquete \texttt{pdflscape} y el entorno \texttt{landscape} proporcionado. La figura~\ref{fig:apaisada} se muestra en página apaisada a modo de ejemplo.

\color{red}{
\textsc{MUY IMPORTANTE}: \emph{Observa que la figura de esta página y la anterior son idénticas, salvo en el formato de fichero empleado. La diferencia del resultado final habla por sí sola.}}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.98\linewidth]{../figs/network} 
	\caption[Gráfico apaisado de Visio (pdf)]{Figura vectorial con vista en página apaisada}
	\label{fig:apaisada}
\end{figure}
\end{landscape}
