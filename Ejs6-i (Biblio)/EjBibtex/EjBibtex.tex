...
%%%%%
% Opción 2: Al producir el resultado definitivo se incluye el contenido del fichero bbl generado por BibTeX de modo que se incluye una lista de referencias que puede editarse a voluntad para corregirla según preferencia personal.
